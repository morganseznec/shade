...
class OpenStackCloud(
    ...
    def list_firewall_rules(self, filters=None):
        ...
        if not filters:
            filters = {}
        data = self._network_client.get(
            "/fw/firewall_rules.json", params=filters,
            error_message="Error fetching firewall rules list")
        return self._get_and_munchify('firewall_rule', data)
    ...
    def list_firewall_policies(self, filters=None):
        ...
        if not filters:
            filters = {}
        data = self._network_client.get(
            "/fw/firewall_policies.json", params=filters,
            error_message="Error fetching firewall policies list")
        return self._get_and_munchify('firewall_policy', data)
    ...
    def list_firewalls(self, filters=None):
        ...
        if not filters:
            filters = {}
        data = self._network_client.get(
            "/fw/firewalls.json", params=filters,
            error_message="Error fetching firewall groups list")
        return self._get_and_munchify('firewall', data)
    ...
    def get_firewall_rule(self, name_or_id, filters=None):
        ...
        """
        return _utils._get_entity(self, 'firewall_rule', name_or_id, filters)
    ...
    def get_firewall(self, name_or_id, filters=None):
        ...
        """
        return _utils._get_entity(self, 'firewall', name_or_id, filters)
    ...
    def get_firewall_policy(self, name_or_id, filters=None):
        ...
        """
        return _utils._get_entity(self, 'firewall_policy', name_or_id, filters)
    ...
    def firewall_policy_insert_rule(self, policy_id, body):
        ...
        """
        data = self._network_client.put("/fw/firewall_policies/{policy_id}/insert_rule".format(policy_id=policy_id), json=body)
    ...
    def firewall_policy_remove_rule(self, policy_id, body):
        ...
        """
        data = self._network_client.put("/fw/firewall_policies/{policy_id}/remove_rule".format(policy_id=policy_id), json=body)
    ...
    def create_firewall_rule(self, fwrule_name, fwrule_description, source_ip_address, destination_ip_address,
                             source_port, destination_port, protocol, action, tenant_id=None):
        ...
        data = self._network_client.post("/fw/firewall_rules.json",
                                         json={"firewall_rule": firewall_rule})
    ...
    def delete_firewall_rule(self, name_or_id):
        ...
        self._network_client.delete(
            "/fw/firewall_rules/{firewall_rule}.json".format(firewall_rule=firewall_rule['id']))
        return True
